...
- [ ] Explain what a token is used for.
  ...
  A token is used to provide authentication to a user on the client side. It is used to stor state information for a specific viewer.

- [ ] What steps can you take in your web apps to keep your data secure?

  Make sure tokens are encoded, use protected routes, employ a third party who specializes in security.

- [ ] Describe how web servers work.

  It is a device that is connected to the internet and stores the code for different websites to be shared across the world at all times. 
